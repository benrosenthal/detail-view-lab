    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mShoppingListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent addGroceryIntent = new Intent(MainActivity.this, DetailActivity.class);
                cursor.moveToPosition(position);
                addGroceryIntent.putExtra("_id", cursor.getInt(cursor.getColumnIndex(ShoppingSQLiteOpenHelper.COL_ID)));
